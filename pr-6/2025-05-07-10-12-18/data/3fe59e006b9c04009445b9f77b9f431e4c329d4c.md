...
+        id: wait-for-deployment
         with:
           ...
           max_timeout: 120
     outputs:
-      deployment_url: ${{ steps.wait-for-deployment-url.outputs.deployment_url }}
